...
def netcat(option=""):
	...
	if option == True:
		...
		options_netcat_rs = ["Basic Netcat Reverse Shell","Netcat OpenBsd Reverse Shell", "Netcat BusyBox Reverse Shell"]
		terminal_menu_lang = TerminalMenu(options_netcat_rs, title="Netcat Reverse Shell")
		option = terminal_menu_lang.show()
		rs = netcat_rs[option]
